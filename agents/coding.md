...
permission:
  ...
  question: deny
name: coding
description: Specialized coding subagent for code-heavy work — editing code, implementing features/fixes, running build/test/lint/typecheck commands, git operations that touch code. Acts as a senior developer who reads and follows the project's own AGENTS.md/CLAUDE.md conventions before acting. Preferred over `general` whenever the task touches the codebase.
---
